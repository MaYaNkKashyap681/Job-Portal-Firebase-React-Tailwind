...
const JobCreationForm = () => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const res = await createJob({
                role, location, jobtype, aboutDesc, reqDesc, company
            });
    ...
    return (
        <div>
            <form onSubmit={handleSubmit} className="w-full mx-auto font-nunito">
                <div className="mb-4">
                    <InputField
                        type="text"
                        name="role"
                ...
                <div className="mt-6">
                    <button
                        type="submit"
                        className="w-full bg-teal-400 text-white font-bold py-2 px-4 rounded-full hover:bg-teal-300 focus:outline-none focus:shadow-outline-blue"
                    >
                        {
